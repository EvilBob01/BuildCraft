...
public interface IToolWrench {
    ...
    boolean canWrench(Player player, InteractionHand hand, ItemStack wrench, BlockHitResult rayTrace);
     ...
     * @param wrench - The item stack that holds the wrench
     * @param rayTrace - The object that is being wrenched */
    void wrenchUsed(Player player, InteractionHand hand, ItemStack wrench, BlockHitResult rayTrace);
}
