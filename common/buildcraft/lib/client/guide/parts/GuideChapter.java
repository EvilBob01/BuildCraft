...
public abstract class GuideChapter extends GuidePart {
    ...
    public int draw(int yIndex, float partialTicks, boolean drawCentral) {
        ...
        float width = font.width(text) + hoverWidth;
        int colour = getColour();
        ...
        float _width = font.width(text) + 12 + hoverWidth + (hasChildren ? 16 : 0);
    ...
    protected int getMousePart() {
        ...
        int width = (int) (font.width(text) + hoverWidth) + (children.isEmpty() ? 0 : 16);
