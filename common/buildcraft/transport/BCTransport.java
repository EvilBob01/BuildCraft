...
public class BCTransport {
    ...
    public BCTransport(IEventBus modEventBus, ModContainer modContainer) {
        ...
        BCTransportRegistries.init(modEventBus);
        BCTransportConfig.init();
        BCTransportBlocks.init(modEventBus);
        BCTransportPipes.init(modEventBus);
        BCTransportPlugs.init(modEventBus);
        BCTransportItems.init(modEventBus);
        BCTransportStatements.init();
        ...
        BCTransportProxy.init(modEventBus);
    }

    private void commonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(BCTransportRegistries::commonSetup);
    }
    ...
    static {
        ...
        registerTag("item.plug.power_adaptor").reg("plug_power_adaptor").locale("PipePowerAdapter").model("plug_power_adaptor").tab("buildcraft.plugs");
        ...
        registerTag("item.pipe.buildcrafttransport.cobblestone_rf").reg("pipe_cobble_rf").locale("PipeRedstoneFluxCobblestone");
        ...
        registerTag("item.pipe.buildcrafttransport.sandstone_rf").reg("pipe_sandstone_rf").locale("PipeRedstoneFluxSandstone");
        ...
        registerTag("item.pipe.buildcrafttransport.diamond_wood_item").reg("pipe_diamond_wood_item").locale("PipeItemsWoodenDiamond");
        registerTag("item.pipe.buildcrafttransport.diamond_wood_fluid").reg("pipe_diamond_wood_fluid").locale("PipeFluidsWoodenDiamond");
        registerTag("item.pipe.buildcrafttransport.diamond_wood_power").reg("pipe_diamond_wood_power").locale("PipePowerWoodenDiamond");
        registerTag("item.pipe.buildcrafttransport.diamond_wood_rf").reg("pipe_diamond_wood_rf").locale("PipeRedstoneFluxWoodenDiamond");
